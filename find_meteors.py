import math									# always put your import statements at the top of the file
import requests

def calc_dist(lat1, lon1, lat2, lon2):		# Always define your function statements at the top before your code
...
def get_dist(meteor):						# Another function defined before the code
